...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(butFil1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, -1, -1));

        labTen1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen1.setText("Ten1");
        jPanel1.add(labTen1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 90, -1, -1));

        labTen5.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen5.setText("Ten5");
        jPanel1.add(labTen5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 70, -1, -1));

        labTen3.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen3.setText("Ten3");
        jPanel1.add(labTen3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 300, -1, -1));

        butFil2.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        butFil2.setText("Filosofo2");
        butFil2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butFil2ActionPerformed(evt);
            }
        });
        jPanel1.add(butFil2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 120, -1, -1));

        labTen2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen2.setText("Ten2");
        jPanel1.add(labTen2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 200, -1, -1));

        labTen4.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        labTen4.setText("Ten4");
        jPanel1.add(labTen4, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, -1, -1));

        butFil3.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        butFil3.setText("Filosofo3");
        butFil3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butFil3ActionPerformed(evt);
            }
        });
        jPanel1.add(butFil3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 250, -1, -1));

        butFil4.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        butFil4.setText("Filosofo4");
        jPanel1.add(butFil4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 250, -1, -1));

        butFil5.setFont(new java.awt.Font("Times New Roman", 0, 18)); // NOI18N
        butFil5.setText("Filosofo5");
        butFil5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                butFil5ActionPerformed(evt);
            }
        });
        jPanel1.add(butFil5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel1.setText("PROBLEMA DE LOS FILOSOFOS");
    ...
    private void butFil2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butFil2ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_butFil2ActionPerformed

    private void butFil5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butFil5ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_butFil5ActionPerformed

    private void butFil3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butFil3ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_butFil3ActionPerformed
    ...
    class FondoPanel extends JPanel {
        ...
        public void paint(Graphics g) {
            imagen = new ImageIcon(getClass().getResource("/Imagen/filosofos_procesos_1.png")).getImage();
